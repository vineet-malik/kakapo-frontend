...
Base URL: `KAKAPO_API_BASE` (no trailing slash), e.g. `http://127.0.0.1:8000` (local) or `https://….cloudfront.net` (HTTPS in front of EC2). All paths below are relative to that base.
