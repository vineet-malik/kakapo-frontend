...
Base URL: `KAKAPO_API_BASE` (no trailing slash), e.g. `https://d3msaxyuekquhy.cloudfront.net` (prod) or `http://127.0.0.1:8000` (local). All paths below are relative to that base.
